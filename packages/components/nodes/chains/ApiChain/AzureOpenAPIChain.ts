...
class AzureOpenApiChain_Chains implements INode {
    ...
    constructor() {
        this.label = 'Azure OpenAPI Chain'
        this.name = 'azureOpenApiChain'
        this.version = 2.0
...
const initChain = async (nodeData: INodeData, options: ICommonObject) => {
    const model = nodeData.inputs?.model as AzureChatOpenAI
...
module.exports = { nodeClass: AzureOpenApiChain_Chains }
